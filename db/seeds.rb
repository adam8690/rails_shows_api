...
u2 = User.create({name: "Mac"})

FavouriteShow.create({user_id: u1.id, show_id: s1.id})
FavouriteShow.create({user_id: u1.id, show_id: s2.id})
FavouriteShow.create({user_id: u1.id, show_id: s3.id})
FavouriteShow.create({user_id: u2.id, show_id: s4.id})
FavouriteShow.create({user_id: u2.id, show_id: s5.id})
